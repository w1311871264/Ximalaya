...
public class PlayTrackPageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        String converUrlLarge = track.getCoverUrlLarge();
        Picasso.with(container.getContext()).load(converUrlLarge).into(item);
        return itemView;
    }
